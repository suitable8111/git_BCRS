...
class DetailListViewController : UIViewController, UIAlertViewDelegate, UIScrollViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(frameForHeight != 1){
            ...
            categoryLabel.frame.origin = CGPoint(x: categoryLabel.frame.origin.x * frameForWidth, y: categoryLabel.frame.origin.y * frameForHeight)
            ...
            categoryLabel.frame.size = CGSizeMake( categoryLabel.frame.width * frameForWidth,  categoryLabel.frame.height * frameForHeight)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        categoryLabel.text = cateDic[curruntState]
    ...
    @IBAction func addFavor(sender: AnyObject) {
        ...
        if (arrFavorite.count == 0){
            ...
            if !isEqual {
                ...
                arrFavorite.removeObjectAtIndex(arrFavorite.count-1)
                let path = getFileName("/myFavorite.plist")
                ...
                alert.show()
                favorBtn.setImage(UIImage(named: "FavorBtn_Cancel.png"), forState: UIControlState.Normal)
                isEqual = false
                }
        }
